<div align="center">
  ...
  ![Typing SVG](https://readme-typing-svg.herokuapp.com?font=Fira+Code&size=22&duration=3000&pause=1000&color=2F81F7&center=true&vCenter=true&width=600&lines=Desenvolvedor+Full+Stack;Especialista+em+Back-end;Python+%7C+Node.js+%7C+React;Sempre+aprendendo+algo+novo!)
...
```python
class JulianoSudecum:
    def __init__(self):
        self.name = "Juliano Sudecum"
        self.location = "Porto Alegre, RS 🇧🇷"
        self.role = "Desenvolvedor Full Stack"
        self.focus = "Back-end Development"
        self.current_job = "Desenvolvedor Full-Stack @ Elevato"
        
    def get_education(self):
        return {
            "bootcamp": "Kenzie Academy Brasil - Desenvolvimento Web Full-Stack (2022-2023)",
            "graduation": "Unisinos - Análise e Desenvolvimento de Sistemas (2023-2026)"
        }
```
